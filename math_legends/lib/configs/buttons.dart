...
class BuyTimeButton extends StatelessWidget {
  final int coinCost;
  final int timeToAdd;
  final VoidCallback onBuyAttempt;

  const BuyTimeButton({
    super.key,
    this.coinCost = 100,
    this.timeToAdd = 15,
    required this.onBuyAttempt,
  });

  @override
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      onPressed: onBuyAttempt,
      icon: const Icon(Icons.more_time, size: 28),
      label: Text(
        '+$timeToAdd Sec Potion\n$coinCost Coins',
        textAlign: TextAlign.center,
        style: const TextStyle(
          fontSize: 16,
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor: Colors.amber[700], // Adjust color to fit your game theme
